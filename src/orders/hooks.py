...
# 正常系のフック
# POST /ordersエンドポイントのテストの後に開始されるフックを作成
...
# GET /orders/{order_id}エンドポイントのテスト前に開始されるフックを作成
@dredd_hooks.before(
...
# PUT /orders/{order_id}エンドポイントのテスト前に開始されるフックを作成
@dredd_hooks.before(
...
# POST /orders/{order_id}/cancelエンドポイントのテスト前に開始されるフックを作成
@dredd_hooks.before(
...
# 異常系のフック
# 422のレスポンスを返すエンドポイントのテスト前に開始されるフックを作成
